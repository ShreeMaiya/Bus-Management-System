...
<head>
    ...
    <style>
        ...
        body {
            background: url("https://www.aanavandi.com/blog/wp-content/uploads/2017/11/ksrtc-fly-bus.jpg") no-repeat center;
    ...
    <div class="main-block" style="width: 100%; margin: 0 auto; height: 100%;">
        ...
        <div class=" left-part">
            ...
            <div class="">
                ...
                <a class="btn btn-item btn-block" style="width: 50%;" href="SuAdminAddTrip.php">Enter Trip Details</a>
				<a class="btn btn-item btn-block" style="width: 50%;" href="timetable.php">TIME TABLE</a>
                ...
                <!-- <a class="btn-item" href="ConFillTripDetails.php">Trip Incharge</a> -->
            </div>
        </div>
    </div>

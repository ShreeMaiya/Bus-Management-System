...
<body>
	...
	<div>
		<a class="btn" href="../../Source/AdminDashboard.html">Admin</a>
	</div>
    ...
    if (isset($_POST['loginC'])) {
	    ...
	    if ($num == 1) {
		    ...
		    header("refresh:0, url=../../Source/conductorDashboard.html");
	    } else {
    ...
    if (isset($_POST['loginD'])) {
	    ...
	    if ($num == 1) {
		    ...
		    $_SESSION['status'] = "Active";
		    header("refresh:0, url=../../Source/Driver_Dashboard.html");
	    } else {
		    echo "<script>alert('incorrect id or password')</script>";
		    echo "<script>location.href='myLogin.php'</script>";
	    }
